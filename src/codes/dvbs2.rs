//! # DVB-S2 LDPC codes
//!
//! This module contains the LDPC codes used in DVB-S2
//!
...
pub enum Code {
    ...
    R9_10,
    /// rate 1/4 short FECFRAME
    /// (the LDPC rate is actually 1/5)
    R1_4short,
    /// rate 1/3 short FECFRAME
    R1_3short,
    /// rate 2/5 short FECFRAME
    R2_5short,
    /// rate 1/2 short FECFRAME
    /// (the LDPC rate is actually 4/9)
    R1_2short,
...
impl Code {
    ...
    pub fn h(self) -> SparseMatrix {
        // Algorithm from Section 5.3.2.1 in [1]
        let mut h = SparseMatrix::new(self.m(), self.n());
        // systematic bits
        for j in 0..self.k() {
            let w = j % 360;
            let t = j / 360;
            let a = self.addresses()[t]
                .iter()
        ...
        for j in 1..self.m() {
            h.insert(j, j + self.k());
            h.insert(j, j + self.k() - 1);
        }
        h
    }

    const fn len(self) -> FrameLen {
        match self {
            Code::R1_4 => FrameLen::Normal,
            Code::R1_3 => FrameLen::Normal,
            Code::R2_5 => FrameLen::Normal,
            Code::R1_2 => FrameLen::Normal,
            Code::R3_5 => FrameLen::Normal,
            Code::R2_3 => FrameLen::Normal,
            Code::R3_4 => FrameLen::Normal,
            Code::R4_5 => FrameLen::Normal,
            Code::R5_6 => FrameLen::Normal,
            Code::R8_9 => FrameLen::Normal,
            Code::R9_10 => FrameLen::Normal,
            Code::R1_4short => FrameLen::Short,
            Code::R1_3short => FrameLen::Short,
            Code::R2_5short => FrameLen::Short,
            Code::R1_2short => FrameLen::Short,
            Code::R3_5short => FrameLen::Short,
            Code::R2_3short => FrameLen::Short,
            Code::R3_4short => FrameLen::Short,
            Code::R4_5short => FrameLen::Short,
            Code::R5_6short => FrameLen::Short,
            Code::R8_9short => FrameLen::Short,
        }
    }

    const fn n(self) -> usize {
        match self.len() {
            FrameLen::Normal => 64800,
            FrameLen::Short => 16200,
        }
    }

    const fn m(self) -> usize {
        match self {
            Code::R1_4 => self.n() * 3 / 4,
            Code::R1_3 => self.n() * 2 / 3,
            Code::R2_5 => self.n() * 3 / 5,
            Code::R1_2 => self.n() / 2,
            Code::R3_5 => self.n() * 2 / 5,
            Code::R2_3 => self.n() / 3,
            Code::R3_4 => self.n() / 4,
            Code::R4_5 => self.n() / 5,
            Code::R5_6 => self.n() / 6,
            Code::R8_9 => self.n() / 9,
            Code::R9_10 => self.n() / 10,
            Code::R1_4short => self.n() * 4 / 5, // LDPC r=1/5
            Code::R1_3short => self.n() * 2 / 3,
            Code::R2_5short => self.n() * 3 / 5,
            Code::R1_2short => self.n() * 5 / 9, // LDPC r=4/9
            Code::R3_5short => self.n() * 2 / 5,
            Code::R2_3short => self.n() / 3,
            Code::R3_4short => self.n() * 14 / 15, // LDPC r=11/15
            Code::R4_5short => self.n() * 2 / 9,   // LDPC r=7/9
            Code::R5_6short => self.n() * 8 / 45,  // LDPC r=37/45
            Code::R8_9short => self.n() / 9,
        }
    }
    ...
    const fn addresses(self) -> &'static [&'static [usize]] {
        match self {
            // Table B.1 in [1]
            Code::R1_4 => &[
                &[
                ...
                &[
                    16419, 24928, 16609, 17248, 7693, 24997, 42587, 16858, 34921, 21042, 37024,
                    20692,
                ],
                &[
                    1874, 40094, 18704, 14474, 14004, 11519, 13106, 28826, 38669, 22363, 30255,
                    31105,
                ],
                &[
                ...
                &[
                    8037, 40401, 13550, 19526, 41902, 28782, 13304, 32796, 24679, 27140, 45980,
                    10021,
                ],
                &[
                    40540, 44498, 13911, 22435, 32701, 18405, 39929, 25521, 12497, 9851, 39223,
                    34823,
                ],
                &[
                ...
                &[
                    18979, 17058, 43130, 4246, 4793, 44030, 19454, 29511, 47929, 15174, 24333,
                    19354,
                ],
                &[
                    16694, 8381, 29642, 46516, 32224, 26344, 9405, 18292, 12437, 27316, 35466,
                    41992,
                ],
                &[
                ...
                &[
                    42858, 32008, 41282, 38773, 26570, 2702, 27260, 46974, 1469, 20887, 27426,
                    38553,
                ],
                &[22152, 24261, 8297],
                &[19347, 9978, 27802],
            ...
            Code::R1_3 => &[
                ...
                &[
                    40701, 36035, 39556, 12366, 19946, 29072, 16365, 35495, 22686, 11106, 8756,
                    34863,
                ],
                &[
            ...
            Code::R2_5 => &[
                ...
                &[
                    13172, 19939, 13354, 13719, 6132, 20086, 34040, 13442, 27958, 16813, 29619,
                    16553,
                ],
                &[
                    1499, 32075, 14962, 11578, 11204, 9217, 10485, 23062, 30936, 17892, 24204,
                    24885,
                ],
                &[
                ...
                &[
                    32321, 10839, 15620, 33521, 23030, 10646, 26236, 19744, 21713, 36784, 8016,
                    12869,
                ],
                &[
                    35597, 11129, 17948, 26160, 14729, 31943, 20416, 10000, 7882, 31380, 27858,
                    33356,
                ],
                &[
                ...
                &[
                    15181, 13645, 34501, 3393, 3840, 35227, 15562, 23615, 38342, 12139, 19471,
                    15483,
                ],
                &[
                    13350, 6707, 23709, 37204, 25778, 21082, 7511, 14588, 10010, 21854, 28375,
                    33591,
                ],
                &[
                ...
                &[
                    34283, 25610, 33026, 31017, 21259, 2165, 21807, 37578, 1175, 16710, 21939,
                    30841,
                ],
                &[
                    27292, 33730, 6836, 26476, 27539, 35784, 18245, 16394, 17939, 23094, 19216,
                    17432,
                ],
                &[
                    11655, 6183, 38708, 28408, 35157, 17089, 13998, 36029, 15052, 16617, 5638,
                    36464,
                ],
                &[
                ...
                &[
                    24418, 27583, 7959, 35562, 37771, 17784, 11382, 11156, 37855, 7073, 21685,
                    34515,
                ],
                &[
                    10977, 13633, 30969, 7516, 11943, 18199, 5231, 13825, 19589, 23661, 11150,
                    35602,
                ],
                &[
                ...
                &[
                    34985, 14441, 25668, 4116, 3019, 21049, 37308, 24551, 24727, 20104, 24850,
                    12114,
                ],
                &[
                    38187, 28527, 13108, 13985, 1425, 21477, 30807, 8613, 26241, 33368, 35913,
                    32477,
                ],
                &[
            ...
            Code::R3_5 => &[
                ...
                &[
                    16581, 22225, 12563, 19717, 23577, 11555, 25496, 6853, 25403, 5218, 15925,
                    21766,
                ],
                &[
                ...
                &[
                    18839, 21132, 20119, 15214, 14705, 7096, 10174, 5663, 18651, 19700, 12524,
                    14033,
                ],
                &[
            ...
            Code::R2_3 => &[
                ...
                &[
                    2, 17957, 6024, 8681, 18628, 12794, 5915, 14576, 10970, 12064, 20437, 4455,
                    7151,
                ],
                &[
                    3, 19777, 6183, 9972, 14536, 8182, 17749, 11341, 5556, 4379, 17434, 15477,
                    18532,
                ],
                &[
                ...
                &[
                    7, 20647, 14311, 11734, 4180, 8110, 5525, 12141, 15761, 18661, 18441, 10569,
                    8192,
                ],
                &[
                    8, 3791, 14759, 15264, 19918, 10132, 9062, 10010, 12786, 10675, 9682, 19246,
                    5454,
                ],
                &[
                ...
                &[
                    11, 14072, 4033, 19959, 12608, 631, 19494, 14160, 8249, 10223, 21504, 12395,
                    4322,
                ],
                &[12, 13800, 14161],
                &[13, 2948, 9647],
...
mod tests {
    ...
    fn regular_row_weight() {
        ...
        for code in Code::into_enum_iter().filter(|code| !very_irregular.contains(code)) {
            ...
            if irregular.contains(&code) {
                assert!(all_rows.all(|r| {
                    let v = h.row_weight(r);
                    v == w + 2 || v == w + 1 || v == w
                }));
            } else {
                assert!(all_rows.all(|r| h.row_weight(r) == w + 1));
            };
        }
    }
}
